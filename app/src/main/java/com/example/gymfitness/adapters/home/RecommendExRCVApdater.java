...
public class RecommendExRCVApdater extends RecyclerView.Adapter<RecommendExRCVApdater.WorkoutViewHolder> {
    ...
    @NonNull
    @Override
    public RecommendExRCVApdater.WorkoutViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RecommendExRCVApdater.WorkoutViewHolder(binding);
    }
    ...
    static class WorkoutViewHolder extends RecyclerView.ViewHolder {
        ...
        public WorkoutViewHolder(@NonNull RecommandRvcItemBinding binding) {
    ...
    @NonNull
    @Override
    public void onBindViewHolder(@NonNull RecommendExRCVApdater.WorkoutViewHolder holder, int position) {
